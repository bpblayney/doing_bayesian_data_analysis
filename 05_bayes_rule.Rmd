...
\begin{center}
\includegraphics[width=2in]{BernGridExample0.pdf}
\includegraphics[width=2in]{BernGridExample1.pdf}
\includegraphics[width=2in]{BernGridExample2.pdf}
\end{center}

\begin{center}
\includegraphics[width=2in]{BernGridExample3.pdf}
\includegraphics[width=2in]{BernGridExample4.pdf}
\includegraphics[width=2in]{BernGridExample5.pdf}
\end{center}

\begin{center}
\includegraphics[width=2in]{BernGridExample6.pdf}
\includegraphics[width=2in]{BernGridExample7.pdf}
\includegraphics[width=2in]{BernGridExample8.pdf}
\end{center}

\begin{center}
\includegraphics[width=2in]{BernGridExample9.pdf}
\includegraphics[width=2in]{BernGridExample10.pdf}
\end{center}
